...
public:
        ...
        : dns_(dns)
    {
        ...
        plot_.setBackgroundColor(sf::Color::Black);
...
int main()
{
    ...
    Pinger google_com("localhost", sf::Vector2i(0, 0));
    /*Pinger google_fr("localhost", sf::Vector2i(0, 1));
    Pinger ensta_fr("localhost", sf::Vector2i(1, 0));    
    Pinger bechu_org("localhost", sf::Vector2i(1, 1));*/
