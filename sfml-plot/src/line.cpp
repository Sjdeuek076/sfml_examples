                ...
                const sf::Color& color)
{
    if(previous_.x != -1 && previous_.y != -1)
    {
        ...
        sf::Vector2f temp;
// if thickness and pwidth equal to 1, the lines will not show. 
        temp.x = p1.x + pwidth_/2 * vp.x;         
        temp.y = p1.y + pwidth_/2 * vp.y;        
        /*temp.x = p1.x + pwidth_ * vp.x;
        temp.y = p1.y + pwidth_ * vp.y; */                            
        ...
        /*temp.x = p2.x + thickness * vp.x;
        temp.y = p2.y + thickness * vp.y;                        */
